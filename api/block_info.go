...
func InitBlockInfoClient(endpoint string) {
...
func (b *BlockInfoClient) request(query string, i interface{}, isJSON bool) error {
	fullPath := b.endpoint + query
	if isJSON {
		fullPath = b.endpoint + query + "?format=json"
	}
